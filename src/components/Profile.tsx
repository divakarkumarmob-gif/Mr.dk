    ...
    return (
        <div className="min-h-screen bg-[#0a0f24] text-white p-4 sm:p-6 font-sans pb-24">
            ...
            <div className="bg-[#161e38] rounded-2xl p-6 border border-white/10 mb-8 flex flex-col items-center">
                ...
                <button onClick={() => onNavigate('editProfile')} className="bg-orange-500 flex items-center gap-1 px-3 py-0.5 rounded-full font-bold text-[10px]">
            ...
            <div onClick={onSolverClick} className="bg-gradient-to-r from-purple-600 to-indigo-600 p-4 rounded-xl mb-6 flex justify-between items-center cursor-pointer">
