    ...
    return (
        <div className="min-h-screen bg-background text-foreground p-2 font-sans pb-16">
            ...
            <div className="bg-card text-card-foreground rounded-lg p-2 border border-border mb-2 flex flex-col items-center">
                ...
                <button onClick={() => onNavigate('editProfile')} className="bg-primary text-primary-foreground flex items-center gap-0.5 px-1.5 py-0 rounded-full font-bold text-[8px]">
            ...
            <div onClick={onSolverClick} className="bg-primary text-primary-foreground p-2 rounded-lg mb-3 flex justify-between items-center cursor-pointer">
            ...
            {/* Premium */}
            <div className="bg-amber-600 text-white p-2 rounded-lg mb-3 flex justify-between items-center cursor-pointer">
                 <div className="flex items-center gap-1.5">
                    <div className="bg-white/20 p-1 rounded-md"><Crown className="h-4 w-4"/></div>
                    <p className="font-bold text-xs">Get Premium</p>
                </div>
                <ChevronRight className="h-4 w-4 opacity-50" />
            </div>
            ...
            <div onClick={() => onNavigate('notesLibrary')} className="bg-orange-500 text-white p-2 rounded-lg mb-2 flex justify-between items-center cursor-pointer">
                 <div className="flex items-center gap-1.5">
            ...
            <button onClick={logOut} className="w-full bg-secondary text-secondary-foreground py-1.5 rounded-md font-bold flex items-center justify-center gap-1 text-[10px]">
