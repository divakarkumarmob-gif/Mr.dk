        ...
        <div className="fixed inset-0 bg-[#0a0f24] text-white z-[120] flex flex-col p-6 overflow-y-auto">
            ...
            {loading ? (
                ...
                <div className="space-y-6">
                    {deepAnalysis ? (
                        <div className="space-y-6">
                            <div className="space-y-1 bg-[#161e38] p-4 rounded-xl border border-white/5">
                                <h4 className="text-lg font-bold text-gray-100">Kya galati hua</h4>
                                <p className="text-sm text-gray-400 whitespace-pre-line">{deepAnalysis.mistakes}</p>
                            </div>
                            <div className="space-y-1 bg-[#161e38] p-4 rounded-xl border border-white/5">
                                <h4 className="text-lg font-bold text-gray-100">Kaise improve kare</h4>
                                <p className="text-sm text-gray-400 whitespace-pre-line">{deepAnalysis.improvement}</p>
                            </div>
                            <div className="space-y-1 bg-[#161e38] p-4 rounded-xl border border-white/5">
                                <h4 className="text-lg font-bold text-gray-100">Future me galti</h4>
                                <p className="text-sm text-gray-400 whitespace-pre-line">{deepAnalysis.future}</p>
                            </div>
                        </div>
                    ) : (
