...
export default function App() {
  ...
  if (currentView === 'profile') {
      return (
        <div className="flex flex-col min-h-screen pb-20 pt-[max(env(safe-area-inset-top,0px),40px)] px-[max(env(safe-area-inset-left,0px),16px)] pr-[max(env(safe-area-inset-right,0px),16px)]">
  ...
  if (currentView === 'admin') {
      return (
          <div className="min-h-screen bg-background pt-[max(env(safe-area-inset-top,0px),40px)] px-[max(env(safe-area-inset-left,0px),16px)] pr-[max(env(safe-area-inset-right,0px),16px)] text-foreground">
  ...
  if (currentView === 'notes') {
      return (
        <div className="flex flex-col min-h-screen pb-20 bg-background pt-[max(env(safe-area-inset-top,0px),40px)] px-[max(env(safe-area-inset-left,0px),16px)] pr-[max(env(safe-area-inset-right,0px),16px)]">
